...
app.get('http://localhost:31846/api/Medicine', (req, res) => { //lists all  available products
    return res.json(data.products);
});

app.post('http://localhost:31846/api/Medicine', (req, res) => { //generates the list of products in the cart
